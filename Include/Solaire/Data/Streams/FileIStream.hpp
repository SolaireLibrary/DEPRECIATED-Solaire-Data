#ifndef SOLAIRE_STL_FILEISTREAM_HPP
#define SOLAIRE_STL_FILEISTREAM_HPP
...
namespace Solaire {
    ...
    public:
        FileIStream(const CString& aString) :
            mStream(&aString[0])
        {}

        SOLAIRE_EXPORT_CALL ~FileIStream() {
            mStream.close();
        }
